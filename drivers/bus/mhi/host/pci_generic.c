...
static const struct mhi_controller_config modem_telit_fe990b_config = {
	.max_channels = 128,
	.timeout_ms = 20000,
	.ready_timeout_ms = 50000,
	.num_channels = ARRAY_SIZE(mhi_telit_fn990_channels),
...
static const struct mhi_pci_dev_info mhi_telit_fe990b_info = {
	.name = "telit-fe990b",
	.config = &modem_telit_fe990b_config,
	.bar_num = MHI_PCI_DEFAULT_BAR_NUM,
	.dma_data_width = 32,
	.sideband_wake = false,
	.mru_default = 32768,
...
static const struct mhi_controller_config modem_telit_fn990b40_config = {
	.max_channels = 128,
	.timeout_ms = 20000,
	.ready_timeout_ms = 50000,
	.num_channels = ARRAY_SIZE(mhi_telit_fn990_channels),
...
static const struct mhi_pci_dev_info mhi_telit_fn990b40_info = {
	.name = "telit-fn990b40",
	.config = &modem_telit_fn990b40_config,
	.bar_num = MHI_PCI_DEFAULT_BAR_NUM,
	.dma_data_width = 32,
	.sideband_wake = false,
	.mru_default = 32768,
...
static const struct pci_device_id mhi_pci_id_table[] = {
	...
	{ PCI_DEVICE_SUB(PCI_VENDOR_ID_QCOM, 0x0309, 0x1c5d, 0x2025),
		.driver_data = (kernel_ulong_t) &mhi_telit_fe990b_info },
